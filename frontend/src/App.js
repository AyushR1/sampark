      ...
      <div className="u-margin-top-xxlarge u-margin-bottom-xxlarge">
        <div className="o-wrapper-l">
          <div className="hero flex flex-column">
            <div>
              <img src={logo} style={{ borderRadius: '30%' }} alt="Sampark" />
            </div>
            <div>
              <div className="actionText">Hi!  <span className={copied ? "username copied" : "username"} onClick={() => { showCopiedMessage() }}>{yourID}</span></div>
            </div>
